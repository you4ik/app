/**
 * The main Express application that handles routing and server setup.
 * 
 * This file sets up the Express application, configures middleware, and defines the main routes for the application.
 * 
 * The application connects to a PostgreSQL database using the `pg` library, and retrieves and renders order data using EJS templates.
 * 
 * The main routes include:
 * - `GET /`: Retrieves and renders a list of orders
 * - `GET /order/:id`: Retrieves and renders the details of a specific order
 * 
 * The application also serves static files from the `public` directory.
 */
